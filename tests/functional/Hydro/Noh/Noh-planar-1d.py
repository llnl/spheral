...
#ATS:t54 = test(       SELF, "--raja True --graphics None --clearDirectories True  --checkError True  --dataDirBase 'dumps-planar-reproducing' --domainIndependent True --outputFile 'Noh-planar-1proc-raja-reproducing.txt'", label="Planar Noh problem with SPH+RAJA -- 1-D (serial reproducing test setup)")
#ATS:t55 = testif(t54, SELF, "--raja True --graphics None --clearDirectories False  --checkError True  --dataDirBase 'dumps-planar-reproducing' --domainIndependent True --outputFile 'Noh-planar-4proc-raja-reproducing.txt' --comparisonFile 'Noh-planar-1proc-raja-reproducing.txt'", np=4, label="Planar Noh problem with SPH+RAJA -- 1-D (4 proc reproducing test)")
...
#ATS:t104 = test(        SELF, "--solid True --graphics None --clearDirectories True  --checkError True  --dataDirBase 'dumps-planar-reproducing' --domainIndependent True --outputFile 'Noh-planar-solid-1proc-reproducing.txt'", label="Planar Noh problem with solid SPH -- 1-D (serial reproducing test setup)")
#ATS:t105 = testif(t104, SELF, "--solid True --graphics None --clearDirectories False  --checkError True  --dataDirBase 'dumps-planar-reproducing' --domainIndependent True --outputFile 'Noh-planar-solid-4proc-reproducing.txt' --comparisonFile 'Noh-planar-solid-1proc-reproducing.txt'", np=4, label="Planar Noh  problem with solid SPH -- 1-D (4 proc reproducing test)")
#
...
#ATS:t154 = test(        SELF, "--raja True --solid True --graphics None --clearDirectories True  --checkError True  --dataDirBase 'dumps-planar-reproducing' --domainIndependent True --outputFile 'Noh-planar-solid-raja-1proc-reproducing.txt'", label="Planar Noh problem with solid SPH+RAJA -- 1-D (serial reproducing test setup)")
#ATS:t155 = testif(t154, SELF, "--raja True --solid True --graphics None --clearDirectories False  --checkError True  --dataDirBase 'dumps-planar-reproducing' --domainIndependent True --outputFile 'Noh-planar-solid-raja-4proc-reproducing.txt' --comparisonFile 'Noh-planar-1proc-reproducing.txt'", np=4, label="Planar Noh  problem with solid SPH+RAJA -- 1-D (4 proc reproducing test)")
#untack("raja_test")
#
# CRK
#
