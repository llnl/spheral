...
#ATS:t14 = test(       SELF, "--DamageModelConstructor GradyKippTensorDamageOwen --graphics False --clearDirectories False --domainIndependent True --raja True", np=1, ngpu=1, label="Tensile rod (GradyKippOwen damage) GPU run", raja_test=True)
#
