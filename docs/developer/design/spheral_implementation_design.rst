...
degrees of freedom. Fields attach typed values to nodes. Field lists present a
global view over several node lists without forcing a single monolithic array.
