...
template void computeInterfacePressureCorrectedSumMassDensity(const ConnectivityMap<Dim<1>>&, 
...
template void computeInterfacePressureCorrectedSumMassDensity(const ConnectivityMap<Dim<2>>&, 
...
template void computeInterfacePressureCorrectedSumMassDensity(const ConnectivityMap<Dim<3>>&, 
