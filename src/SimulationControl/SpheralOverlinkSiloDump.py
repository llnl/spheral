...
# Voronoi meshes that can be read by Overlink
#
# Format version:
...
class SpheralOverlinkSiloDump:
    ...
    def dump(self, simulationTime, cycle, format = "ascii"):
        ...
        self.dumpFileName(filename, simulationTime, cycle, format)

    def dumpFileName(self, filename, simulationTime, cycle, format = "ascii"):
...
def dumpPhysicsState(stateThingy,
    ...
    dumper = SpheralOverlinkSiloDump(baseFileName,
                                     baseDirectory,
                                     fields,
                                     fieldLists,
                                     boundaries,
