...
will get the new value regardless of resetValues."""
    ...
    globalMassRZ = PYB11property("FieldList<%(Dimension)s, Scalar>")
    ...
    fluidMassRZ = PYB11property("FieldList<%(Dimension)s, Scalar>")
    ...
    fluidMassDensityRZ = PYB11property("FieldList<%(Dimension)s, Scalar>")
    ...
    solidMassRZ = PYB11property("FieldList<%(Dimension)s, Scalar>")
    ...
    solidMassDensityRZ = PYB11property("FieldList<%(Dimension)s, Scalar>")
