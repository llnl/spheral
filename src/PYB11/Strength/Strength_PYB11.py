...
class SolidFieldNames:
    ...
    tensorDamageTT = PYB11readonly(static=True, returnpolicy="copy")
    ...
    strainTensorTT = PYB11readonly(static=True, returnpolicy="copy")
    effectiveStrainTensor = PYB11readonly(static=True, returnpolicy="copy")
    effectiveStrainTensorTT = PYB11readonly(static=True, returnpolicy="copy")
