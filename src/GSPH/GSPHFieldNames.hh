...
struct GSPHFieldNames {
  ...
  const inline static std::string specificThermalEnergyGradient = "specific thermal energy gradient";
  ...
  const inline static std::string maxFluxSpeed = "maximum flux speed";
};
